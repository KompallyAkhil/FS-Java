...
public class Day11P1 {
    ...
    public static boolean isSelMirrorTree(TreeNode left , TreeNode right ){
        ...
        return left.val == right.val && isSelMirrorTree(left.left, right.right) && isSelMirrorTree(left.right, right.left);
    }
    public static void main(String[] args) {
        ...
        System.out.println(isSelMirrorTree(root.left, root.right));
        sc.close();
    }
}
